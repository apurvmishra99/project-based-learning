import tweepy
from tkinter import *
from t_bot_config import consumer_key, consumer_secret, access_token, access_token_secret
...
label2 = Label(root, text="Number of tweets you wish to interact with")
E2 = Entry(root, bd=5)
...
submit = Button(root, text="Submit", command=main_function)
